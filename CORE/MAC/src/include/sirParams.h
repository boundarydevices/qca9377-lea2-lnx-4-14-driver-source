...
#if 1
#define SIR_HAL_NFLIMIT_SET_CMD             (SIR_HAL_ITC_MSG_TYPES_BEGIN + 379)
#define SIR_HAL_SET_THRESH62_CMD            (SIR_HAL_ITC_MSG_TYPES_BEGIN + 380)
#define SIR_HAL_WLAN_DTIM_POLICY            (SIR_HAL_ITC_MSG_TYPES_BEGIN + 381)
#endif
