                                          ...
                                          )
{
    ...
    {
        count = 0;
        /* remove 14ch for SDMAC module because it still have not got the approval */
                                         ...
                                         bool reset)
{
    ...
    for (i = 0, m = 0; i<IEEE80211_NUM_BANDS; i++)
    {
        ...
        if (i == 0)
            m = 0;
        else if (IEEE80211_BAND_2GHZ == (i - 1))
        {
             /* silex removed 14ch from wiphy bands for SDMAC.
              * But driver regards that a module supports 14ch. So, silex sets RF_CHAN_240 as
              * a start point of next freq band.
              */
             m = RF_CHAN_36;
        }
        else
